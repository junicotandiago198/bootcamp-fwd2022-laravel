                                    ...
                                    <div class="card-body card-dashboard">
                                        <form class="form form-horizontal" action="{{ route('backsite.doctor.store') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    <label for="fee" class="col-md-3 label-control">Fee <code style="color: red;">required</code></label>
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" name="fee" id="fee" class="form-control" placeholder="example fee 10000" value="{{old('fee')}}" autocomplete="off" data-inputmask="'alias': 'numeric', 'groupSeparator': ',', 'autoGroup': true, 'digits':0, 'digitsOptional': 0, 'prefix': 'IDR ', 'placeholder': '0'" required>
