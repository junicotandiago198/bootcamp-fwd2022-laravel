                                    ...
                                    <div class="card-body card-dashboard">
                                        ...
                                        <form class="form form-horizontal" action="{{ route('backsite.role.store') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" name="title" id="title" class="form-control" placeholder="example admin or users" value="{{ old('title') }}" autocomplete="off" required>

                                                        @if($errors->has('title'))
                                                            <p style="font-size: bold; color: red;">{{ $errors->first('title') }}</p>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-actions text-right">
                                                <button type="submit" style="width:120px;" class="btn btn-cyan" onclick="return confirm('Are you sure want to save this data ?')"><i class="la la-check-square-o"></i> Submit</button>
                                            </div>
                                        </form>
                                                                ...
                                                                <td class="text-center">
                                                                    <div class="btn-group mr-1 mb-1">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            ...
                                                                            @endcan
                                                                            @can('role_edit')
                                                                                <a href="{{ route('backsite.role.edit', $role_item->id) }}" class="dropdown-item">Edit</a>
                                                                            @endcan

                                                                            {{-- condition button delete --}}
                                                                            @if ($role_item->id > 3)
                                                                                @can('role_delete')
