                            ...
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal" action="{{ route('backsite.role.update', [$role->id]) }}" method="POST" ecntype="multipart/form-data">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" name="title" id="title" class="form-control" placeholder="example admin or users" value="{{ old('title', isset($role) ? $role->title : '') }}" autocomplete="off" required>
